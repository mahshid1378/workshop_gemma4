# Step 4 — Create the regional GCS bucket · RTX track
...
> them at cold start instead of pulling ~62 GB from HuggingFace every time.
>
...
|---|---|
| ⏱ **Time** | ~1 minute |
| 💰 **Cost** | ~$0 now; storage is ~$0.02/GB/mo. 62 GB ≈ ~$1.20/mo if you forget to delete it. `step_99` cleans it up. |
