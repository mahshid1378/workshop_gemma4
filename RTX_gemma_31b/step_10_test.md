# Step 10 — Test the endpoint · RTX track
...
> the fun part. You're now talking to a 31B Gemma 4 model running on your own
> Cloud Run GPU.
...
# Expect a fluent Tagalog answer — this is the 31B model showing off.
```
...
> 🎉 You just served a 31B Gemma 4 model on a Cloud Run GPU. The audience is
> running the same stack on smaller GPUs — same commands, smaller numbers.
