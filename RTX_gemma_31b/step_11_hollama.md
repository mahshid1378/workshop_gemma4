# Step 11 — Chat through a UI: Hollama (optional) · RTX track
...
- Your **public service URL** from Step 10 (looks like `https://gemma-rtx-...run.app`)
- Your model's short name: `google/gemma-4-31B-it`
...
# 6. Click Verify -> your Gemma model (google/gemma-4-31B-it) appears. Then chat.
```
