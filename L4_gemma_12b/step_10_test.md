# Step 10 — Test the endpoint · L4 · 12B track
...
> the fun part. You're now running the **newest Gemma 4 model** (12B, released by
> Google on June 2, 2026) on your own Cloud Run L4 GPU.
...
# Expect a fluent, nuanced Tagalog answer — 12B handles multilingual noticeably
# better than the smaller E4B.
```
...
> 🎉 You just served Gemma 4 12B — Google's newest mid-size model (June 2026) —
> on a Cloud Run L4 GPU, the same stack the speaker is running at 31B scale. Same
> commands, bigger model than the E4B starter track (`L4_gemma_e4b/`), identical
> hourly cost. Same recipe, smarter model.
