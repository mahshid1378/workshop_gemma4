# Step 99 — Tear everything down · L4 · 12B track
...
> ⚠️ **Sharing a project with the E4B L4 track?** The bucket and VPC are shared
> by name. If you still want the E4B track running, **skip the bucket/subnet/
