# Step 11 — Chat through a UI: Hollama (optional) · L4 · 12B track
...
- Your **public service URL** from Step 10 (looks like `https://gemma-l4-12b-...run.app`)
- Your model's short name: `google/gemma-4-12B-it`
...
# 6. Click Verify -> your Gemma model (google/gemma-4-12B-it) appears. Then chat.
```
