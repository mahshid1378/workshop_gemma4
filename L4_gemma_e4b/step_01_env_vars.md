# Step 1 — Set environment variables · L4 · E4B track (Gemma 4 E4B)
...
**Prerequisites**
- Completed [`00_prerequisites.md`](../00_prerequisites.md): project + billing, HF token, and you **accepted the Gemma 4 E4B terms** at <https://huggingface.co/google/gemma-4-E4B-it>
...
> ```bash
> export GCS_MODEL_LOCATION="gs://<PROJECT_ID>-asia-southeast1-hf-model-cache/model-cache/google/gemma-4-E4B-it"
> ```
...
```bash
# ---------- Model ----------
# Gemma 4 E4B: the "Edge" 4B-parameter variant — compact, fast, designed to fit
# on small GPUs (and even phones). Instruction-tuned ("-it"). Great L4 starter.
export MODEL_NAME="google/gemma-4-E4B-it"

# ---------- Cloud Run service ----------
# Model-suffixed name so this never clashes with the 12B L4 service or the RTX one.
# Lowercase letters, numbers, hyphens only.
export SERVICE_NAME=gemma-l4-e4b-vllm-workshop
