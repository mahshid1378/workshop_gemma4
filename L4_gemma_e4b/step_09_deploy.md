# Step 9 — Deploy to Cloud Run · L4 · E4B track
...
> Run service: it pulls the vLLM image, attaches an L4 GPU, loads the E4B weights
...
| | |
|---|---|
| ⏱ **Time** | ~3–5 min (most of it is the first cold-start model load) |
